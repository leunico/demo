...
(10,	8,	7,	'秘密杀手',	0,	1,	'2017-12-07 09:13:47',	'2017-12-06 09:52:25',	NULL),
...
(13,	8,	0,	'测试分组',	0,	1,	'2017-12-08 11:24:05',	'2017-12-08 11:24:05',	NULL),
(14,	8,	13,	'测试子分组',	0,	1,	'2017-12-08 11:24:19',	'2017-12-08 11:24:19',	NULL);
...
(37,	0,	'API接口',	'存放接口信息',	'project/index/api',	1,	'random',	1,	2,	'2017-12-07 11:08:19',	'2017-11-24 01:32:30',	NULL),
...
(18,	'interface_method',	'提交的方式',	'basic',	'method',	'string',	'{\"post\":\"POST\",\"get\":\"GET\",\"put\":\"PUT\",\"delete\":\"DELETE\",\"head\":\"HEAD\"}',	'',	'',	'',	NULL,	NULL);
...
CREATE TABLE `albert_interface` (
  ...
  `interface_Status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `interface_Remark` varchar(255) NOT NULL DEFAULT '',
